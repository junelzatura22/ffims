                      ...
                      @case('Admin')
                          ...
                          <li class="nav-item @if (Request::segment(2) == 'management') menu-open @endif">
                              ...
                              <ul class="nav nav-treeview ">
                                  ...
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/position') }}
                                          class="nav-link {{ Request::is('admin/management/position') ? 'active' : '' }}">
                                          <i class="fa-solid fa-users-line nav-icon"></i>
                                          <p>Position</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/designation') }}
                                          class="nav-link {{ Request::is('admin/management/designation') ? 'active' : '' }}">
                                  ...
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/commodity') }}
                                          class="nav-link {{ Request::is('admin/management/commodity') ? 'active' : '' }}">
                                          <i class="fa-solid fa-tractor nav-icon"></i>
                                          <p>Commodity</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/farmactivity') }}
                                          class="nav-link {{ Request::is('admin/management/farmactivity') ? 'active' : '' }}">
                          ...
                          <li class="nav-item @if (Request::segment(2) == 'f2') menu-open @endif">
                              ...
                              <ul class="nav nav-treeview ">
                                  ...
                                  <li class="nav-item">
                                      <a href={{ route('f2.list') }}
                                          class="nav-link @if (Request::segment(2) == 'f2') active @endif">
                                          <i class="fa-solid fa-people-roof nav-icon"></i>
                                          <p>Farmer/Fisherfolk List</p>
                                      </a>
                                  </li>
                                  ...
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/farmactivity') }}
                                          class="nav-link {{ Request::is('admin/management/farmactivity') ? 'active' : '' }}">
                                          <i class="fa-sharp fa-solid fa-chart-area nav-icon"></i>
                                          <p>Farmer Activity</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href={{ url('admin/management/farmactivity') }}
                                          class="nav-link {{ Request::is('admin/management/farmactivity') ? 'active' : '' }}">
                                          <i class="fa-solid fa-fish-fins nav-icon"></i>
                                          <p>Fisherfolk Activity</p>
                                      </a>
                                  </li>
                              </ul>
